...
/dashboard                      → Dashboard chính
  ...
  /feedbacks                    → Đóng góp ý kiến (Khen/Chê/Đề xuất)
```
...
- **Contribution** — Đóng góp ý kiến từ người dùng (Khen/Chê/Đề xuất), lưu trữ tệp đính kèm trên Google Drive (attachments) và phản hồi của Admin
