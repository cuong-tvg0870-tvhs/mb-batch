...
export const CAMPAIGN_FIELDS = [
  ...
  Campaign.Fields.special_ad_category_country,
...
export const ADSET_FIELDS = [
  ...
  AdSet.Fields.regional_regulated_categories,
  AdSet.Fields.dsa_beneficiary,
  AdSet.Fields.dsa_payor,
...
export const CREATIVE_FIELDS = [
  ...
  AdCreative.Fields.image_crops,
  AdCreative.Fields.video_id,
  AdCreative.Fields.thumbnail_id,
  ...
  AdCreative.Fields.destination_spec,
  AdCreative.Fields.object_store_url,
  AdCreative.Fields.status,
  AdCreative.Fields.effective_object_story_id,
  AdCreative.Fields.effective_instagram_media_id,
  AdCreative.Fields.instagram_permalink_url,
  AdCreative.Fields.instagram_user_id,
  AdCreative.Fields.object_story_spec,
  AdCreative.Fields.product_set_id,
  AdCreative.Fields.template_url_spec,
  AdCreative.Fields.degrees_of_freedom_spec,
  AdCreative.Fields.platform_customizations,
  AdCreative.Fields.page_welcome_message,
